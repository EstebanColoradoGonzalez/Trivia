package com.trivia.transversal.utilitario;

import java.text.ParseException;
import java.text.SimpleDateFormat;
import java.util.Date;
import com.trivia.transversal.excepcion.TriviaTransversalExcepcion;
...
public class UtilFecha 
{
	...
	public static Date formatearFecha(String fechaTexto, String formato)
	{
		...
		{
			throw new TriviaTransversalExcepcion(excepcion.getMessage());
		}
